    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_club', models.ForeignKey(on_delete=models.SET('Unknown'), to='base.club')),
                ('nationality', models.ForeignKey(on_delete=models.SET('Unknown'), to='base.nation')),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('players', models.ManyToManyField(blank=True, related_name='players', to='base.player')),
            ],
            options={
                'verbose_name': 'user',
